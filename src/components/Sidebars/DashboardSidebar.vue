<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<a-menu theme="light" mode="inline" class="sidebar-top">
				<a-menu-item>
					<router-link to="/myrecordings">
						<span class="icon">
						...
						<span class="label">My Recordings</span>
					</router-link>
				</a-menu-item>
				<a-menu-item>
					<router-link to="/requested">
						<span class="icon">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<span class="label">Rquested</span>
					</router-link>
				</a-menu-item>
			</a-menu>
